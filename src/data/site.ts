...
export const brand = {
  ...
  mapUrl: 'https://maps.google.com/?q=ул.+Брегалница+1,+Гоце+Делчев',
...
export const gallery = {
  ...
  rows: [
    [
      ...
      { src: '/media/her/chasha-sinya.webp', w: 520, h: 280, span: 4,
        alt: 'Ръчно рисувана синя керамична чаша',
        caption: 'Шарката я измисля този, който я прави' },
      { src: '/media/her/magazin.webp', w: 540, h: 700, span: 3,
    ...
    [
      ...
      { src: '/media/gallery/chasha-risuvana.webp', w: 1300, h: 1832, span: 3,
        alt: 'Ръчно рисувана керамична чаша',
    ...
    [
      { src: '/media/gallery/sin-servis.webp', w: 1300, h: 1947, span: 3,
      ...
      { src: '/media/gallery/chasha-cherna.webp', w: 1300, h: 867, span: 5,
  ...
  items: [
    {
      ...
      a: 'Не същата вечер. Глината трябва да изсъхне и да мине два пъти през пещта - веднъж преди глечта и веднъж след нея. Пиша ти, щом е готова, и си я вземаш от магазина. Изпичането е включено в цената.',
    },
    {
    ...
    {
      q: 'Ами ако се запишем малко хора?',
      a: 'Работилницата тръгва при трима записани, а на масата има място за осем. Ако до няколко дни преди датата не се съберем толкова, ти се обаждам и избираме друга - мястото ти остава запазено за нея.',
    },
    {
